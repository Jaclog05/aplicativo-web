...
function Sidebar({ onClick, options }) {
  ...
  return (
    <aside
      className="h-md-100 p-md-2 d-md-flex flex-md-column col-md-2 bg-light"
    >
      <div className="text-center mb-md-2">
        ...
        <p className="mb-0 fst-italic text-break px-2" style={{fontSize: '0.8rem'}}>admin1@example.com</p>
      </div>

      <hr className="d-none d-md-block"/>

      <p className="d-none d-md-block my-md-2" style={{fontSize: '16px', fontWeight: '900px' }}>Opciones</p>

      <nav className="d-flex align-items-center justify-content-center">
        <ul className="w-100 p-0 mb-0 list-unstyled list-inline d-flex d-md-block justify-content-around" style={{fontSize: '14px'}}>
