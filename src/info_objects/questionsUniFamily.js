export const questionsUniFamilyArray = [
  ...
  },
  {
    ...
    "subgroup": "Accesibilidad",
    "parameter": "Accesibilidad",
    "measurement": "Las preguntas orientadoras van enfocadas a conocer el estado (bueno, regular o malo) de las vías vehiculares y peatonales de acceso hasta la entrada principal de la unidad residencial. También la presence de baldosas podotáctiles y rampas que ayudan al acceso fácil e independiente de las personas con discapacidad.",
    "explanation": "Elementos o espacios que nos permiten acceder a la vivienda, (Vías vehiculares, andenes, escaleras, ascensores, rampas, entre otros).",
  ...
  },
  {
    ...
    "subgroup": "Accesibilidad",
    "parameter": "Zona de riesgo",
    "measurement": "Las preguntas orientadoras van enfocadas a conocer si fenómenos naturales (arroyos), industria (emoción de gases) o alto flujo vehicular (contaminación auditiva) afectan directamente a la unidad residencial. En este caso, la presencia de estos factores resulta en la disminución de la calidad. A su vez se toman en cuenta, factores de seguridad como la presence de rutas de evacuación adecuadas en caso de incendio.",
    "explanation": "Elementos que representen una amenaza en el sitio ya sea que afecten la movilidad, la salud del residente o su seguridad.",
  ...
  },
  {
    ...
    "subgroup": "Utilidad",
    "parameter": "Asoleamiento",
    "measurement": "En este caso la incidencia directa del sol por un period de tiempo largo es causante de altas temperaturas al interior de la vivienda, es por esto que la ausencia de los rayos solares en todos los espacios de la unidad en horas críticas (9:00 - 16:00) aportan calidad a la residencia",
    "explanation": "En arquitectura el soleamiento se considera como la incidencia del sol en el objeto arquitectónico.",
  ...
  },
  {
    ...
    "subgroup": "Utilidad",
    "parameter": "Espacios",
    "measurement": "Las preguntas orientadoras en este parámetro buscan incluir las preferencias del usuario en el puntaje de calidad de su vivienda, como las habitaciones que desea, los espacios adicionales que posee la casa, etcEn este caso nos enfocados en los acabados esenciales con los que debe contar a vivienda, pisos, baños y cocina",
    "explanation": "Diferentes medios físicos que permiten el desarrollo de actividades cotidianas para el ser humano como dormir, asearse, recrearse, entre otros.",
